...
%== HEADER ==%
\begin{center}
    {\fontsize{36}{36}\selectfont\interthin{KATIE} \interheavy{GUNDERMANN}} \\ \bigskip
    {\color{icnclr}\faEnvelope[regular]} \href{mailto:hi@example.com}{kpgund@psu.edu} $|$ 
    {\color{icnclr}\faIcon{mobile-alt}} \href{tel:1234567890}{717-222-9135} $|$
    {\color{icnclr}\faLinkedinIn} \href{https://www.linkedin.com/}{linkedin.com/in/fancy\_rover}
\end{center}

\section{Education}
%==============
\subsection{The Pennsylvania State University $|$ {\normalfont\textit{Doctor of Philosophy}} \hfill 2026}
\begin{itemize}
...
\subsection{The Pennsylvania State University $|$ {\normalfont\textit{Master of Science}} \hfill 2022}
\begin{itemize}
    \item Cumulative GPA: 3.98
    \item Related Coursework: Intro to Programming with Python, Database Administration
    \item Rover Resume Award
